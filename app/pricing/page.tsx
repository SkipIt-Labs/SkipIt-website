        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border border-white/10 rounded-2xl p-8 bg-black/40">
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-white text-black font-semibold hover:bg-white/90 transition disabled:opacity-50"
            >
          ...
          {/* Yearly */}
          <div className="border border-white/20 rounded-2xl p-8 bg-black/50 relative overflow-hidden">
